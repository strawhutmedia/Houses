...
const METRO_BY_CITY = {
  CA: {
    ...
    "pasadena": "Los Angeles", "altadena": "Los Angeles", "south pasadena": "Los Angeles",
    "san marino": "Los Angeles", "alhambra": "Los Angeles", "san gabriel": "Los Angeles",
    "sierra madre": "Los Angeles", "arcadia": "Los Angeles", "monrovia": "Los Angeles",
    "temple city": "Los Angeles", "glendale": "Los Angeles", "burbank": "Los Angeles",
    "la canada flintridge": "Los Angeles", "la cañada flintridge": "Los Angeles",
    "eagle rock": "Los Angeles", "highland park": "Los Angeles", "montrose": "Los Angeles",
    "tujunga": "Los Angeles", "sunland": "Los Angeles", "sherman oaks": "Los Angeles",
    "studio city": "Los Angeles", "north hollywood": "Los Angeles", "van nuys": "Los Angeles",
  },
  OR: {
...
function normalizeListing(raw) {
  ...
  return {
    ...
    price,
    marketValue,
    priceOnInquiry: raw.priceOnInquiry === true,
